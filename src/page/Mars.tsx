...
import marsImg03 from '../assets/images/planet-mars-geology.png'

const Mars = () => {const [info, setInfo] = useState<planet | undefined>(undefined)
const [description, setDescription] = useState<string | undefined>('')

useEffect(() => {
  axios
    .get('http://localhost:8080/planet/filter/mars')
    ...
    >
      <div className="grid grid-cols-3  items-center">
        <div className="col-span-2">
          <div className="flex justify-center">
            ...
            {description === info?.surfaceGeology && (
              ...
              >
                <div>
                  <img className="w-90" src={marsImg02} />
                  <img
                    className="absolute ml-16 mt-48 top-96 w-48"
                    src={marsImg03}
                    alt="img planet"
                  />
                </div>
        ...
        <div className="w-80 col-span-1">
          ...
          {description === '' ? (
            <p className="text-slate-400 text-xl h-36 mt-5 ">
              {info?.overview}
            </p>
          ) : (
          ...
          <p className="text-slate-500 text-lg mt-20 ">
            Source:
            <span className="text-slate-500 cursor-pointer duration-300 hover:text-red-400">
              Wikipedia
            </span>
          </p>
          <div className="flex flex-col gap-4 mt-10">
            <button
              ...
              className="text-white uppercase flex gap-8 text-2xl border border-red-400 w-full px-8 py-2 hover:bg-red-600 duration-500"
            >
              <p>01</p>
              <span>overview</span>
            </button>
