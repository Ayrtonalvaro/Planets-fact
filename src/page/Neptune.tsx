...
import neptuneImg03 from '../assets/images/planet-neptune-geology.png'
...
const Neptune = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:8080/planet/filter/neptune')
      ...
      <div className="grid grid-cols-3  items-center">
        <div className="col-span-2">
          <div className="flex justify-center">
            ...
            {description === info?.surfaceGeology && (
              ...
              >
                <div>
                  <img className="w-90" src={neptuneImg02} />
                  <img
        ...
        <div className="w-80 col-span-1">
          ...
          <p className="text-slate-500 text-lg mt-20">
            Source:
            <span className="text-slate-400 cursor-pointer duration-300 hover:text-sky-400">
              Wikipedia
            </span>
          </p>
          <div className="flex flex-col gap-4 mt-10">
            <button
              ...
              className="text-white uppercase flex gap-8 text-2xl border border-sky-400 w-full px-8 py-2 hover:bg-sky-600 duration-500"
            >
              <p>01</p>
              <span>overview</span>
            </button>
